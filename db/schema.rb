...
ActiveRecord::Schema.define(version: 20200419163827) do

  create_table "maps", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "title",                                null: false
    t.string   "coment"
    t.decimal  "latitude",   precision: 20, scale: 15, null: false
    t.decimal  "longitude",  precision: 20, scale: 15, null: false
